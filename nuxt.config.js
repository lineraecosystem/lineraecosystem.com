...
const title = 'Linera Ecosystem | A curated list of Linera Ecosystem projects'
const description =
	'A curated list of Linera Ecosystem projects'
export default {
	...
	head: {
		...
		meta: [
			...
			},
			{
				name: 'keywords',
				content:
					'Linera, Linera Ecosystem , Zefchain Labs , Linera News, Linera Eco',
			},
			{
				name: 'og:image',
