...
const githubLink = "https://github.com/lineraecosystem/lineraecosystem.com";
const telegramLink = "https://t.me/lineraecosystem";
const twitterLink = "https://twitter.com/lineraecosystem";
  ...
  return (
    ...
    >
      <HStack>
        ...
        <Link isExternal active href="https://twitter.com/LineraEcosystem">
      ...
      <SimpleGrid columns={[2, 2, 3, 5]} spacing="20px" w="full">
        ...
        <VStack align="flex-start">
          ...
          <VStack align="flex-start" fontSize="sm" pr={8}>
            {renderTooltip(
              "Linera Ecosystem is your guide to the Linera world"
            )}
          </VStack>
        </VStack>
        <VStack align="flex-start">
