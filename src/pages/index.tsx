    ...
    >
      ...
      >
        ...
        <HighlightedText
          ...
          highlighted={t.common.hundreds || "Linera"}
        />
        <Box
          boxSize="600px"
          position="absolute"
          ...
          zIndex={0}
        >
          <Image src="/mesh-2.svg" alt="Starknet Astro" />
        </Box>
      </Flex>
      {/* Sub intro text */}
      <Text
      ...
      >
        {t.common.subtitle_main ||
          "Linera is a layer-1 blockchain protocol designed to bring the elastic scaling of web2 to web3"}
      </Text>
